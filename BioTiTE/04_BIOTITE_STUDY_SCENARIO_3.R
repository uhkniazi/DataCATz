# ==============================================================================
# File: 04_BIOTITE_STUDY_SCENARIO_3
# Auth: u.niazi@soton.ac.uk
# Date: 08/09/2026
# Desc: Evaluates Tier 0 (GLM), Tier 1 (Standard Stan Normal(0,2)), and Tier 2 
#       (BioTiTE_V2) when Gene1 expression is partially confounded with dose level.
# ==============================================================================
...
mean(ext_biotite$tau)
sd(ext_biotite$tau)
quantile(ext_biotite$tau,c(.025,.5,.975))
