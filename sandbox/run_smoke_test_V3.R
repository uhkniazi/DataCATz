...
# ==============================================================================
set.seed(42)
N_sims     <- 24  # Total trials simulated across the parallel cluster
...
# ==============================================================================
# Set up worker count: Consume maximum available processing threads minus 1 to prevent system lockups
num_workers <- min(detectCores() - 1, N_sims)
