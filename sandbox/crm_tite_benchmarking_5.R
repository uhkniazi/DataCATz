...
# ==============================================================================
set.seed(42)
N_sims     <- 20  # Total trials to execute
N_patients <- 20
T_max      <- 28
target_dlt <- 0.25
...
# 1. Re-build the data frame without rounding the text column
...
# 2. Round ONLY the numeric columns (columns 2, 3, and 4)
oc_summary[, 2:4] <- round(oc_summary[, 2:4], 2)

# 3. Print your beautifully formatted results
cat("\n========================================================================\n")
cat("            FINAL CLINICAL TRIAL OPERATING CHARACTERISTICS              \n")
cat("========================================================================\n")
print(oc_summary)
